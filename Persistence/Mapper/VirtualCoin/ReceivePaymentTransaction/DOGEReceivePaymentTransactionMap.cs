...
{
    public class DOGEReceivePaymentTransactionMap : BaseClassMapping<DOGEReceivePaymentTransaction>
    {
        public DOGEReceivePaymentTransactionMap()
        {
            ...
            Property(x => x.Amount, map => { map.NotNullable(true); map.Precision(16); map.Scale(4); });
