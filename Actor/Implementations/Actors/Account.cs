...
﻿using Dotpay.Actors.Implementations.Events;
﻿using Dotpay.Common;
...
namespace Dotpay.Actors.Implementations
{
    ...
    public class Account : EventSourcingGrain<Account, IAccountState>, IAccount
    {
        ...
        public Task<Immutable<Dictionary<CurrencyType, decimal>>> GetBalances()
        {
            return Task.FromResult(this.State.Balances.AsImmutable());
        }
        #endregion
