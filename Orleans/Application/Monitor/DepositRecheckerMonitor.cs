...
namespace Dotpay.Application.Monitor
{
    internal class DepositRecheckerMonitor : IApplicationMonitor
    {
        ...
        private void StartMessageConsumer()
        {
            ...
            var consumer = new ConfirmDepositTransactionMessageConsumer(_channel);
        ...
        private class ConfirmDepositTransactionMessageConsumer : DefaultBasicConsumer
        {

            public ConfirmDepositTransactionMessageConsumer(IModel model) : base(model) { }
