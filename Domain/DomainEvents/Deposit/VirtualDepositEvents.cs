...
namespace DotPay.Domain.Events
{
    ...
    {
        public VirtualCoinDepositCreated(int userID, int accountID, string txid, CurrencyType currency, decimal amount, decimal fee, string memo, DepositType depositType, VirtualCoinDeposit deposit)
        {
            this.UserID = userID;
