...
namespace DotPay.Domain.Events
{
    ...
    public class CurrencyDepositRateModified : DomainEvent
    {
        public CurrencyDepositRateModified(int currencyID, decimal depositFixedFee, decimal depositFeeRate, int byUserID)
        {
            this.CurrencyID = currencyID;
            this.DepositFixedFee = depositFixedFee;
            this.DepositFeeRate = depositFeeRate;
    ...
    public class CurrencyConfirmationsModified : DomainEvent
    {
        public CurrencyConfirmationsModified(int currencyID, int needConfrim, int byUserID)
        {
            this.CurrencyID = currencyID;
            this.NeedConfirm = needConfrim;
            this.ByUserID = byUserID;
        }
        public int CurrencyID { get; private set; }
        public int NeedConfirm { get; private set; }
