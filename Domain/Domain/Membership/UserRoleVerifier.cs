...
namespace DotPay.Domain
{
    ...
    #endregion
    {
        ...
        public void Handle(CurrencyDepositRateModified @event) { this.VerifyManagerIsSystemManager(@event.ByUserID); }
        public void Handle(CurrencyWithdrawRateModified @event) { this.VerifyManagerIsSystemManager(@event.ByUserID); }
        public void Handle(CurrencyConfirmationsModified @event) { this.VerifyManagerIsSystemManager(@event.ByUserID); }
        #endregion 
