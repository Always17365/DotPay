...
namespace DotPay.Domain
{
                           ...
                           IEventHandler<VirtualCoinDepositCompleted>
    {
        ...
        public VirtualCoinDeposit(int userID, int accountID, string txid, CurrencyType currency, decimal amount, decimal fee, string memo, DepositType depositType)
        {
            this.RaiseEvent(new VirtualCoinDepositCreated(userID, accountID, txid, currency, amount, fee, memo, depositType, this));
        }
        #endregion
